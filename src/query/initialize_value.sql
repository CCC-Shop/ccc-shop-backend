...
INSERT `shipping_discount` (`vender_id`, `policy_description`, `start_time`, `end_time`, `target_price`) VALUES
...
INSERT `seasonings_discount` (`vender_id`, `policy_description`, `start_time`, `end_time`, `discount_rate`) VALUES
...
INSERT `special_discount` (`product_id`, `vender_id`, `policy_description`, `start_time`, `end_time`, `category`) VALUES
