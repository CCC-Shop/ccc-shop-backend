...
VALUES ('admin', 'admin', 'admin', '0912312345', 'admin@gmail.com', '0000111-2222333', 'home'),
       ...
       ('customer1', 'customer', 'customer1', '0918537624', 'customer1@gmail.com', '2222333-4444555',
        '台北市大安區忠孝東路xxx號5F'),
...
VALUES (2, 'computer1', 'COMPUTER', 50000, 1000, 'XX市XX區XX路XX號XX樓', 'one of computer', 'https://xxx.xxx'),
...
VALUES (2, 'using for xxx', '2021-01-01 00:00:00', '2021-12-31 23:59:59', 500),
...
VALUES (2, 'using for xxx', '2021-01-01 00:00:00', '2021-12-31 23:59:59', 0.5),
...
VALUES (5, 3, 'using for xxx', '2021-01-01 00:00:00', '2021-12-31 23:59:59', 'Computer'),
...
INSERT `order` (`customer_id`, `shipping_fee`, `recipient_name`, `shipping_address`, `status`, `payment_method`,
                `credit_card_id`, `order_time`, `shipping_time`, `delivery_time`, `seasoning_discount_code`,
                `shipping_discount_code`)
VALUES (4, 200, 'customer1', '台北市大安區忠孝東路xxx號5F', 'ORDER', 'CASH', NULL, '2021-11-24 20:34:30', '2021-11-25 20:34:30',
        '2021-11-26 20:34:30', NULL, NULL),
       (4, 100, 'customer?', '台北市大安區忠孝東路OOO號5F', 'SHIPPING', 'CREDIT_CARD', '2222333-4444555', '2021-11-26 20:34:30',
        NULL, NULL, 1, NULL),
       (5, 300, 'customer2', '台北市大安區忠孝東路xxx號5F', 'DELIVERED', 'CASH', '3333444-5555666', '2021-11-24 20:34:30',
        '2021-11-25 20:34:30', '2021-11-26 20:34:30', NULL, 1),
       (5, 80, 'customer2', '台北市大安區忠孝東路xxx號5F', 'RECEIVED', 'CREDIT_CARD', '3333444-5555666', '2021-11-25 20:34:30',
        '2021-11-26 20:34:30', NULL, 1, NULL),
